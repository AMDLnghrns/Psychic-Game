...
In this assignment, you'll create "Psychic". These apps will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
...
1. Create a new GitHub repo called `Psychic-Game`. Then, clone it to your computer.
